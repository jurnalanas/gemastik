...
class Location_list extends CI_Controller
{
	...
	public function get()
	{
		...
		$result = $this->datatables->getData('markers', array('markers_name','category_name','markers_phone','markers_url','markers_address','markers_logo','markers_lat','markers_lng','markers_desc','markers_id','markers_category_id'), 'markers_id',array('category','markers.markers_category_id = category.category_id','inner'));
		echo $result;
